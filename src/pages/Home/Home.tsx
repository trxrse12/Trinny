...
export const Home = () =>{
    return (
        <div style={{padding: 24, textAlign: 'left'}}>
            ...
            <Typography variant="body1" gutterBottom>
                Currently there are no tests written for the questions, please feel free to add some if you have time. Tests can be run via <span style={{fontWeight:'bold'}}>yarn test</span>
            </Typography>
        </div>
    )
}
