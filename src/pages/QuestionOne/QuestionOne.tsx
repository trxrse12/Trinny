    ...
    return (
        <div style={{padding:16, display: 'flex', flexDirection:'column'}} >
            ...
            <Typography variant="body1"  gutterBottom color='error'>
                The code for this problem can be found at './src/pages/QuestionOne/ProblemOne.tsx'
            </Typography>
            <Typography variant="body1" gutterBottom>
            ...
            <CardMedia
                ...
                title="The Solution"
            />
            <Button variant="contained" color="secondary" onClick={()=>history.push('./problemOne')}>
                Start Problem
            </Button>
        </div>
    )
